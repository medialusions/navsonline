...
$config['groups'] = [
    'admins' => 's_admin,admin',
    'viewer' => 'viewer',
    'denied' => 'archived,denied'
];
...
$config['remember_me_cookie_name'] = 'navsRememberMe';
...
$config['http_user_cookie_name'] = 'navsHttpUser';
...
$config['http_user_cookie_elements'] = ['user_identification'];
