...
$config['groups'] = [
    'Editors' => 'Scheduler,Editor,Administrator',
    'Viewers' => 'Scheduled Viewer,Viewer'
];
...
$config['remember_me_cookie_name'] = 'NavsOnlinePersistentLogin';
...
$config['http_user_cookie_name'] = 'NavsOnlineSession';
